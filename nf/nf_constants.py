class NfConstants:
    ...
    BS_INDEX_RPA_REMARKS_BULK_SERVICE = 29
    BS_INDEX_RPA_REMARKS_BASE_FLOW = 30
    BS_INDEX_RPA_REMARKS_DOUBLE_FLOW = 31
    BS_INDEX_RPA_REMARKS_EXTEND_FLOW = 32
    BS_INDEX_RPA_REMARKS_KEYWORD = 33
    BS_INDEX_RPA_REMARKS_AUX_FLOW = 34

    # NF COLUMN BULK SERVICE
    COLUMN_BULK_SERVICE_DEPLOYMENT_DATE = 29
    COLUMN_BULK_SERVICE_RPA_REMARKS = 30
    COLUMN_BULK_SERVICE_RPA_REMARKS_BASE_FLOW = 31
    COLUMN_BULK_SERVICE_RPA_REMARKS_DOUBLE_FLOW = 32
    COLUMN_BULK_SERVICE_RPA_REMARKS_EXTEND_FLOW = 33
    COLUMN_BULK_SERVICE_RPA_REMARKS_KEYWORD = 34
    COLUMN_BULK_SERVICE_RPA_REMARKS_AUX_FLOW = 35
