...
def nf_start_bulk_services(bs_worksheet, webdriver, gsheet):
    ...
    for i, row in enumerate(pending_rows):
        try:
            ...
            wd.perform_action(
                "name",
                os.getenv("NF_BS_MAX_DAILY_EXTENSION"),
                "sendkeys",
            ...
            wd.perform_action(
                "name",
                os.getenv("NF_BS_MAX_TOTAL_EXTENSION"),
                "sendkeys",
    ...
    try:
        ...
        if "no" in row_data[20].lower():
            ...
            wd.perform_action(
                ...
                "expiry",
                "sendkeys",
                int(row_data[nf.NF_INDEX_DEFAULT_DURATION_IN_DAYS]) * 24,
            )
